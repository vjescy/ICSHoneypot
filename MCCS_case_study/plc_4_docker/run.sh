#!/bin/bash
SQL_SCRIPT="INSERT INTO Programs (Name, Description, File, Date_upload) VALUES ('PLC4', 'Descrizione', 'PLC4.st', strftime('%s', 'now'));"
...
if ! [[ -f "$FILE" ]]; then
    ...
    cp /home/OpenPLC_v3/scripts/PLC4.st /home/OpenPLC_v3/webserver/st_files
    cp /home/OpenPLC_v3/scripts/PLC4.st.dbg /home/OpenPLC_v3/webserver/st_files
    ...
    echo PLC4.st >> /home/OpenPLC_v3/webserver/active_program
